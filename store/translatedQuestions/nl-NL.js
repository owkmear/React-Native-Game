...
const questions = [
  {
    ...
    variants: [
      "`Lydia` en `undefined`",
      "`Lydia` en `ReferenceError`",
      "`ReferenceError` en `21`",
  ...
  },
  {
    ...
    code: '+true;\n!"Lydia";',
    correctAnswer: 1,
    variants: ["`1` en `false`", "`false` en `NaN`", "`false` en `false`"],
    explanation:
  ...
  },
  {
    ...
    correctAnswer: 1,
    variants: [
      "`mouse.bird.size` is ongeldig",
      "`mouse[bird.size]` is ongeldig",
      '`mouse[bird["size"]]` is ongeldig',
      "Alle antwoorden zijn geldig",
    ],
    explanation:
  ...
  },
  {
    ...
    correctAnswer: 1,
    variants: [
      "Niets, dit is helemaal goed!",
      "`SyntaxError`. Je kunt op deze manier geen properties toevoegen aan een functie.",
      '`"Woof"` wordt gelogd.',
      "`ReferenceError`",
    ],
    explanation:
  ...
  },
  {
    ...
    correctAnswer: 1,
    variants: [
      '`Person {firstName: "Lydia", lastName: "Hallie"}` en `undefined`',
      '`Person {firstName: "Lydia", lastName: "Hallie"}` en `Person {firstName: "Sarah", lastName: "Smith"}`',
      '`Person {firstName: "Lydia", lastName: "Hallie"}` en `{}`',
    ],
    explanation:
  ...
  },
  {
    grade: Grades.Junior,
    theme: Themes.EVENTS,
    question: "Wat zijn de drie fases van event propagation?",
    code: null,
    correctAnswer: 4,
    variants: [
  ...
  },
  {
    grade: Grades.Junior,
    theme: Themes.CLASSES,
    question: "Alle objecten bevatten prototypes.",
    code: null,
    correctAnswer: 2,
    variants: ["true", "false"],
    explanation:
  ...
  },
  {
    grade: Grades.Middle,
    theme: Themes.BASICS,
    question: "Wat is de waarde van `sum`?",
  ...
  },
  {
    grade: Grades.Middle,
    theme: Themes.BASICS,
    question: "Hoe lang is cool_secret benaderbaar?",
    code: 'sessionStorage.setItem("cool_secret", 123);',
    correctAnswer: 2,
    variants: [
      "Voor altijd, de data gaat niet verloren.",
      "Wanneer de gebruiker de tab sluit.",
      "Wanneer de gebruiker de gehele browser sluit, niet alleen de tab.",
      "Wanneer de gebruiker zijn computer afsluit.",
    ],
    explanation:
  ...
  },
  {
    ...
    theme: Themes.BASICS,
    question:
      'De JavaScript global execution context maakt twee dingen aan voor je: het globale object, en het "this" keyword.',
    code: null,
    correctAnswer: 1,
    variants: ["true", "false", "het hangt er vanaf"],
    explanation:
  ...
  },
  {
    grade: Grades.Middle,
    theme: Themes.BASICS,
    question: "Wat is de event.target wanneer geklikt wordt op de knop?",
    code: null,
    correctAnswer: 3,
    variants: [
      "Buitenste `div`",
      "Binnenste `div`",
      "`button`",
      "Een array van alle geneste elementen.",
    ],
    explanation:
  ...
  },
  {
    grade: Grades.Middle,
    theme: Themes.BASICS,
    question: "Wat wordt er gelogd wanneer je op de paragraaf klikt?",
    code: null,
    correctAnswer: 1,
  ...
  },
  {
    grade: Grades.Middle,
    theme: Themes.BASICS,
    question: "Welke van deze waarden zijn falsy?",
    code: '0;\nnew Number(0);\n("");\n(" ");\nnew Boolean(false);\nundefined;',
    correctAnswer: 1,
    variants: [
      "`0`, `''`, `undefined`",
  ...
  },
  {
    grade: Grades.Middle,
    theme: Themes.BASICS,
    question: "Alles in JavaScript is of een...",
    code: null,
    correctAnswer: 1,
    variants: [
      "primitieve of een object",
      "functie of een object",
      "lastige vraag! alleen objecten",
      "nummer of een object",
    ],
    explanation:
  ...
  },
  {
    grade: Grades.Middle,
    theme: Themes.BASICS,
    question: "Wat geeft de `setInterval` methode terug in de browser?",
    code: 'setInterval(() => console.log("Hi"), 1000);',
    correctAnswer: 1,
    variants: [
      "een uniek id",
      "het aantal opgegeven milliseconden",
      "de doorgegeven functie",
      "`undefined`",
    ],
    explanation:
  ...
  },
  {
    grade: Grades.Middle,
    theme: Themes.BASICS,
    question: "Wat is de waarde van `num`?",
  ...
  },
  {
    ...
    variants: [
      "`1` `2` en `3` `3` en `6` `4`",
      "`1` `2` en `2` `3` en `3` `4`",
      "`1` `undefined` en `2` `undefined` en `3` `undefined` en `4` `undefined`",
      "`1` `2` en `undefined` `3` en `undefined` `4`",
    ],
    explanation:
  ...
  },
  {
    ...
    theme: Themes.BASICS,
    question:
      "Met welke constructor kunnen we succesvol de `Dog` class extenden?",
  ...
  },
  {
    ...
    variants: [
      '`"🥑💻"`',
      "`257548`",
      "Een string die hun code points bevat",
      "Error",
    ],
    explanation:
  ...
  },
  {
    ...
    theme: Themes.BASICS,
    question:
      "Hoe kunnen we de waarden loggen die uitgecommentarieerd zijn achter de console.log statement?",
    code: 'function* startGame() {\n  const answer = yield "Do you love JavaScript?";\n  if (answer !== "Yes") {\n    return "Oh wow... Guess we\'re gone here";\n  }\n  return "JavaScript loves you back ❤️";\n}\n\nconst game = startGame();\nconsole.log(/* 1 */); // Do you love JavaScript?\nconsole.log(/* 2 */); // JavaScript loves you back ❤️',
    correctAnswer: 3,
    variants: [
      '`game.next("Yes").value` en `game.next().value`',
      '`game.next.value("Yes")` en `game.next.value()`',
      '`game.next().value` en `game.next("Yes").value`',
      '`game.next.value()` en `game.next.value("Yes")`',
    ],
    explanation:
  ...
  },
  {
    grade: Grades.Middle,
    theme: Themes.BASICS,
    question: "Is dit een pure function?",
    code: "function sum(a, b) {\n  return a + b;\n}",
    correctAnswer: 1,
    variants: ["Ja", "Nee"],
    explanation:
  ...
  },
  {
    grade: Grades.Middle,
    theme: Themes.BASICS,
    question: "Welke informatie zal worden gelogd?",
    code: "fetch('https://www.website.com/api/user/1')\n  .then(res => res.json())\n  .then(res => console.log(res))",
    correctAnswer: 3,
    variants: [
      "Het resultaat van de `fetch` methode.",
      "Het resultaat van de tweede aanroep van de `fetch` methode.",
      "Het resultaat van de callback in de vorige `.then()`.",
      "Het zal altijd undefined zijn.",
    ],
    explanation:
  ...
  },
  {
    ...
    theme: Themes.BASICS,
    question:
      "Welke optie is een manier om `hasName` te vullen met de boolean waarde `true`, terwijl je geen `true` mee kan geven als argument?",
  ...
  },
  {
    ...
    correctAnswer: 1,
    variants: [
      "`name` `Lydia` en `age` `21`",
      '`["name", "Lydia"]` en `["age", 21]` ',
      '`["name", "age"]` en `undefined`',
      "`Error`",
    ],
    explanation:
  ...
  },
  {
    ...
    variants: [
      ...
      "`a is bigger`, `undefined` en `b is bigger`, `undefined`",
  ...
  },
  {
    ...
    variants: [
      ...
      '`[1, [2, 3, 4]]` en `{ name: "Lydia", age: 21 }`',
      '`[1, 2, 3, 4]` en `{ name: "Lydia", age: 21 }`',
      '`Error` en `{ name: "Lydia", age: 21 }`',
    ],
    explanation:
  ...
  },
  {
    grade: Grades.Middle,
    theme: Themes.BASICS,
    question: "Wat is de waarde van output?",
  ...
  },
  {
    ...
    correctAnswer: 4,
    variants: [
      "`I have resolved!`, `second` en `I have resolved!`, `second`",
      "`second`, `I have resolved!` en `second`, `I have resolved!`",
      "`I have resolved!`, `second` en `second`, `I have resolved!`",
      "`second`, `I have resolved!` en `I have resolved!`, `second`",
    ],
    explanation:
  ...
  },
  {
    grade: Grades.Middle,
    theme: Themes.BASICS,
    question: "Welke van onderstaande methoden passen de originele array aan?",
  ...
  },
  {
    ...
    variants: [
      ...
      "Ontleedt een JavaScript object naar JSON",
      "Ontleedt elke JavaScript waarde naar JSON",
  ...
  },
  {
    grade: Grades.Middle,
    theme: Themes.BASICS,
    question: "Wat zal er gebeuren?",
    code: "let config = {\n  alert: setInterval(() => {\n    console.log('Alert!')\n  }, 1000)\n}\n\nconfig = null",
    correctAnswer: 3,
    variants: [
      "De `setInterval` callback zal niet worden aangeroepen",
      "De `setInterval` callback zal één keer aangeroepen worden",
      "De `setInterval` callback zal nog steeds elke seconde aangeroepen worden",
      "We roepen `config.alert()` nooit aan, config is `null`",
    ],
    explanation:
  ...
  },
  {
    grade: Grades.Middle,
    theme: Themes.BASICS,
    question: "Welke methode(n) zal de waarde `'Hello world!'` teruggeven?",
    code: "const myMap = new Map()\nconst myFunc = () => 'greeting'\n\nmyMap.set(myFunc, 'Hello world!')\n\n//1\nmyMap.get('greeting')\n//2\nmyMap.get(myFunc)\n//3\nmyMap.get(() => 'greeting')",
    correctAnswer: 2,
    variants: ["1", "2", "2 en 3", "Allemaal"],
    explanation:
  ...
  },
  {
    grade: Grades.Middle,
    theme: Themes.BASICS,
    question: "Welke van onderstaande opties zal `6` teruggeven?",
  ...
  },
  {
    ...
    correctAnswer: 2,
    variants: [
      "The driver drove 130 en has to pay 300",
      "The driver drove 130 mph en has to pay \\$300.00",
      "The driver drove undefined en has to pay undefined",
      "The driver drove 130.00 en has to pay 300.00",
    ],
    explanation:
  ...
  },
  {
    grade: Grades.Middle,
    theme: Themes.BASICS,
    question: "Welke van onderstaande zal het `person` object aanpassen?",
  ...
  },
  {
    ...
    variants: [
      ...
      "`I'm pink. 🌸` `I'm a bird. 🦢`",
      "`I'm a bird. 🦢` `I'm pink. 🌸`",
      "Niets, we hebben geen methode aangeroepen",
    ],
    explanation:
  ...
  },
  {
    grade: Grades.Middle,
    theme: Themes.BASICS,
    question: "Welke van onderstaande opties zal resulteren in een error?",
    code: 'const emojis = ["🎄", "🎅🏼", "🎁", "⭐"];\n\n/* 1 */ emojis.push("🦌");\n/* 2 */ emojis.splice(0, 2);\n/* 3 */ emojis = [...emojis, "🥂"];\n/* 4 */ emojis.length = 0;',
    correctAnswer: 4,
    variants: ["1", "1 en 2", "3 en 4", "3"],
    explanation:
  ...
  },
  {
    ...
    theme: Themes.BASICS,
    question:
      'Wat moeten we aan het `person` object toevoegen om `["Lydia Hallie", 21]` als uitkomst te krijgen van `[...person]`?',
    code: 'const person = {\n  name: "Lydia Hallie",\n  age: 21\n}\n\n[...person] // ["Lydia Hallie", 21]',
    correctAnswer: 3,
    variants: [
      "Niets, objecten zijn standaard iterabel",
