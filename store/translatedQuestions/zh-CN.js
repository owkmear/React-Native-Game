...
const questions = [
  ...
  },
  {
    grade: Grades.Junior,
    theme: Themes.EVENTS,
    question: "当点击按钮时，event.target 是什么？",
    code: null,
    correctAnswer: 3,
    variants: [
      "Outer `div`",
  ...
  },
  {
    grade: Grades.Junior,
    theme: Themes.DATA_TYPES,
    question: "JavaScript 中的一切都是？",
    code: null,
    correctAnswer: 1,
    variants: ["基本类型与对象", "函数与对象", "只有对象", "数字与对象"],
    explanation:
  ...
  },
  {
    grade: Grades.Middle,
    theme: Themes.ASYNC,
    question: "如何能打印出`console.log`语句后注释掉的值？",
  ...
  },
  {
    ...
    correctAnswer: 3,
    variants: [
      "`setInterval` 的回调不会被调用",
      "`setInterval` 的回调被调用一次",
      "`setInterval` 的回调仍然会被每秒钟调用",
      "我们从没调用过 `config.alert()`, config 为 `null`",
    ],
    explanation:
  ...
  },
  {
    grade: Grades.Junior,
    theme: Themes.OBJECTS,
    question: "以下哪一项会对对象 `person` 有副作用？",
  ...
  },
  {
    grade: Grades.Junior,
    theme: Themes.OBJECTS,
    question: '哪个作为`method`的值可以打印`{ name: "Lydia", age: 22 }`?',
